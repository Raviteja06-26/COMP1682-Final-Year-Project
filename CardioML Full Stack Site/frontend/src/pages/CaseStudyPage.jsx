...
const RESOURCES = [
  ...
  { icon: "✅", label: "Data Validation", sub: "Google Colab", link: "https://colab.research.google.com/drive/1ZnpZftOrulx0kPO88oB7RYmh7NkeVszK" },
  { icon: "🔬", label: "Full Feature Research", sub: "Google Colab", link: "https://colab.research.google.com/drive/12o7479vqNgYgXH6iHJbfqI1XJinXFy5h" },
  { icon: "🎯", label: "Site Feature Research", sub: "Google Colab", link: "https://colab.research.google.com/drive/1EbbiCMUWpAXGmm1gVLJLbooDhuEbMKGi" },
  { icon: "🚀", label: "Deployment Notebook", sub: "Google Colab", link: "https://colab.research.google.com/drive/1IjgKjjRKI-bMJQzgWGj0GEBrMPc0WVvn" },
  { icon: "💻", label: "GitHub", sub: "Source Code", link: "https://github.com/Raviteja06-26/COMP1682-Final-Year-Project" },
];
          ...
          >
            ...
            <div className="relative">
              ...
              <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight max-w-3xl">
                Building an ML-Based<br />Cardiovascular Risk Prediction System
              </h1>
              <p className="text-blue-100/75 text-base sm:text-lg max-w-2xl mb-8 leading-relaxed">
                From raw clinical data to a production-ready machine learning system — dataset validation, iterative model experimentation, and explainable ML integration.
              </p>
