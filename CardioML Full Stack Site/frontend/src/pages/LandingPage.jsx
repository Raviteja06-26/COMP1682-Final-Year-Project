...
const RESOURCES = [
  ...
  },
  {
    ...
    link: "https://colab.research.google.com/drive/1ZnpZftOrulx0kPO88oB7RYmh7NkeVszK",
    color: "#059669",
  },
  {
    icon: "🔬",
    ...
    link: "https://colab.research.google.com/drive/12o7479vqNgYgXH6iHJbfqI1XJinXFy5h",
    color: "#7c3aed",
  },
  {
    icon: "🎯",
    ...
    link: "https://colab.research.google.com/drive/1EbbiCMUWpAXGmm1gVLJLbooDhuEbMKGi",
    color: "#d97706",
  },
  {
    icon: "🚀",
    ...
    link: "https://colab.research.google.com/drive/1IjgKjjRKI-bMJQzgWGj0GEBrMPc0WVvn",
    color: "#0ea5e9",
  },
  {
    icon: "💻",
    title: "GitHub Repository",
    label: "https://github.com/Raviteja06-26/COMP1682-Final-Year-Project",
    desc: "Full project source code, notebooks, and development history.",
    link: "https://github.com/Raviteja06-26/COMP1682-Final-Year-Project",
    color: "#6366f1",
  },
];
...
const STEPS = [
  ...
  { num: "02", title: "ML model analyzes your profile", desc: "The ML model processes your clinical data against learned cardiovascular patterns." },
    ...
    >
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold mb-8 animate-fade-in"
            ...
            Final Year Project · ML-Based Healthcare
          </div>
          ...
          <div className="relative grid md:grid-cols-2 gap-10 items-center">
            <div style={{
              ...
              <h2 className="font-display text-2xl sm:text-3xl font-bold text-white mb-4 leading-tight">
                Heart Risk Prediction System by<br />
                <span style={{ background: "linear-gradient(90deg, #60a5fa, #a78bfa)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
                  Ravi Teja
                </span>
              </h2>
              <p className="text-blue-100/70 text-sm leading-relaxed mb-4">
                An end-to-end Machine Learning-based cardiovascular risk prediction system combining a trained ML model, FastAPI REST backend, MongoDB database, and React frontend into a complete clinical decision-support application.
              </p>
              <a
                href="https://github.com/Raviteja06-26/COMP1682-Final-Year-Project"
                target="_blank"
                rel="noopener noreferrer"
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          >
            © 2025 Heart Risk Prediction System · Final Year Project · Built by Ravi Teja
          </p>
